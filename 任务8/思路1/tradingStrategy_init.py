...
def slidingWindowTrading(df, backtestStartDate, backtestEndDate, sampleYear, initBalance=1000000):
    ...
    bestDf = pd.DataFrame(
        columns=['样本内数据年份数', '第iyear窗口', '最佳策略',
                 'bestMA1',
    ...
    for iyear in range(0, backtestYear):
        ...
        # 保存
        bestDf['样本内数据年份数'] = sampleYear
        bestDf['第iyear窗口'] = iyear
        bestDf['最佳策略'] = bestStrategy
        if bestStrategy == '1':
            bestDf['bestMA1'] = bestMA1
        elif bestStrategy == '2':
            bestDf['bestShortMA2'] = bestShortMA2
            bestDf['bestMediumMA2'] = bestMediumMA2
        elif bestStrategy == '3':
            bestDf['bestShortMA3'] = bestShortMA3
            bestDf['bestMediumMA3'] = bestMediumMA3
            bestDf['bestLongMA3'] = bestLongMA3
        elif bestStrategy == '4':
            bestDf['bestShortEMA4'] = bestShortEMA4
            bestDf['bestMediumEMA4'] = bestMediumEMA4
        elif bestStrategy == '5':
            bestDf['bestDEA15'] = bestDEA15
            bestDf['bestDEA25'] = bestDEA25
        elif bestStrategy == '6a':
            bestDf['bestBuyD6a'] = bestBuyD6a
            bestDf['bestSellD6a'] = bestSellD6a
        elif bestStrategy == '6b':
            bestDf['bestBuyJ6b'] = bestBuyJ6b
            bestDf['bestSellJ6b'] = bestSellJ6b
        elif bestStrategy == '6c':
            bestDf['bestBuyJ6c'] = bestBuyJ6c
            bestDf['bestSellJ6c'] = bestSellJ6c
