...
# 计算所有组合
itAllStrategyDf = ts.getAllStrategy(df, startDate, endDate, buyDRange, sellDRange)
# 计算最佳组合
bestBuyD, bestSellD, bestNetAsset = ts.getBestStrategy(itAllStrategyDf)
# 计算最佳组合明细
bestStrategyDf = ts.strategy(df, startDate, endDate, bestBuyD, bestSellD)
