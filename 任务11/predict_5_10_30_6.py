...
resultDfFile = r'./result/resultDf_5_10_30_6.csv'
...
# 参数
forecastDays = 5  # 预测未来第几天的股价
pastDays = 10  # 记忆天数, 过去n日作为一组
maValue = 30  # MA取值
...
realPreDf, ratio = LSTM.LSTMPredict(df, backtestStartDate, backtestEndDate, forecastDays, pastDays, maValue,
