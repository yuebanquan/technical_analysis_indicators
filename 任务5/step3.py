...
bestMACDDfFile = r"./result/1_bestMACDDf.csv"
backtestTradingDfFile = r"./result/2_backtestTradingDf.csv"
revenuesFile = r"./result/3_revenues.csv"
...
bestMACDDf.to_csv(bestMACDDfFile, encoding='utf-8-sig', index=False)
backtestTradingDf.to_csv(backtestTradingDfFile, encoding='utf-8-sig')
revenues.to_csv(revenuesFile, encoding='utf-8-sig', header=False)
